...
Max_file_info = max(dbutils.fs.ls("abfss://raw-data@projectstorage997.dfs.core.windows.net/data/sales_data.csv/"))
...
df.coalesce(1).write.format("csv").mode("overwrite").option("header", "true").save("abfss://curated@projectstorage997.dfs.core.windows.net/curateddata")
...
source_path = "abfss://curated@projectstorage997.dfs.core.windows.net/curateddata/"
destination_path = "abfss://curated@projectstorage997.dfs.core.windows.net/curated_renamed/curated_sales_data.csv"
